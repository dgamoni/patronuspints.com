...
<?php 
    ...
    //var_dump($featured_gif);
    if ( $featured_gif) {
      $gif_class= 'featured_gif_enable';
    } else {
      $gif_class= '';
    }
?>
<div class="<?php echo $gif_class; ?>_wrap">
  <figure class="woocommerce-product-gallery__wrapper <?php echo implode(' ', $slider_classes); ?> <?php echo $gif_class; ?>"
    ...
    <div class="featured_gif_hover">
      <img class="featured_gif" src="<?php echo $featured_gif['url']; ?>">
    </div>
